  ...
  return (
    <View style={[styles.card, { backgroundColor: colors.card }]}>
      ...
      <View style={styles.text}>
        ...
        <Text style={[styles.subtext, { color: colors.text + '99' }]}>Let's make an impact today</Text>
      </View>
...
const styles = StyleSheet.create({
  card: { flexDirection: 'row', alignItems: 'center', borderRadius: 12, padding: 12, shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 8, shadowOffset: { width: 0, height: 2 }, elevation: 4 },
